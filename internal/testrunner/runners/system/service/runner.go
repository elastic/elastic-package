...
type Runner interface {
	// SetUp implements the logic for setting up a service. It return a context (map) containing
	// any information resulting from the setup, e.g. connection address information.
	SetUp() (ctx, error)
