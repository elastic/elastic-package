...
echo "      - label: \":go: Integration test: build-install-zip-file-composable\""
echo "        command: ./.buildkite/scripts/integration_tests.sh -t test-build-install-zip-file-composable"
echo "        agents:"
echo "          provider: \"gcp\""
echo "          image: \"${UBUNTU_X86_64_AGENT_IMAGE}\""
echo "        artifact_paths:"
echo "          - build/elastic-stack-dump/install-zip-composable/logs/*.log"

echo "      - label: \":go: Integration test: build-install-zip-file-composable-shellinit\""
echo "        command: ./.buildkite/scripts/integration_tests.sh -t test-build-install-zip-file-composable-shellinit"
echo "        agents:"
echo "          provider: \"gcp\""
echo "          image: \"${UBUNTU_X86_64_AGENT_IMAGE}\""
echo "        artifact_paths:"
echo "          - build/elastic-stack-dump/install-zip-composable-shellinit/logs/*.log"
