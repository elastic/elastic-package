...
Start a Language Server Protocol (LSP) server for Elastic integration packages.

The LSP server communicates over stdin/stdout and provides real-time validation
diagnostics for integration packages opened in supported editors. When you open
or save any file inside a package, the server runs the same validation as
`elastic-package lint` and pushes diagnostics (errors) back to your editor.

Flags:
- `--log-file <path>` — write debug logs to a file (useful for troubleshooting).

#### Demo

Run the included demo script to see the LSP in action without an editor:

```
$ ./scripts/lsp-demo.sh ./elastic-package

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  Scenario 1: Valid package (apache)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  Scenario 2: Broken package (invalid name, missing files)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  File: data_stream/mystream/manifest.yml
    [ERROR] expecting to find [fields] folder in ...

  File: manifest.yml
    [ERROR] field owner: type is required
    [ERROR] field name: Does not match pattern '^[a-z0-9_]+$'
    [ERROR] expecting to find [changelog.yml] file in ...
    [ERROR] expecting to find [docs] folder in ...

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  Scenario 3: Open data_stream file — LSP discovers package root
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  (same errors as Scenario 2 — the LSP walks up to find the package root)
```

The script creates a temporary broken package, sends JSON-RPC messages to the
LSP, and pretty-prints the diagnostics it receives back.

#### Zed editor extension

A companion Zed extension is available at
[`zed-elastic-package`](https://github.com/elastic/zed-elastic-package). To
install it for development:

1. Build elastic-package with the `lsp` command and ensure it is on your `PATH`:
   ```
...
2. Clone the extension repo:
   ```
   git clone https://github.com/elastic/zed-elastic-package.git
   ```

3. In Zed, open the command palette and run **zed: Install Dev Extension**,
   then select the `zed-elastic-package` directory.

4. Open any integration package. YAML and JSON files will automatically get
   validation diagnostics from the LSP.

To point the extension at a custom binary path, add this to your Zed settings:
