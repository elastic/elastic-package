...
The `elastic-package update documentation` command can generate or update package documentation using an LLM. It supports full rewrites, targeted modifications, and quality evaluation. For detailed usage, modes, flags, and configuration (including LLM provider setup), run:
