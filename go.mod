...
require (
	...
	github.com/elastic/package-spec/v2 v2.0.0
...
replace github.com/elastic/package-spec/v2 => github.com/elastic/package-spec/v2 v2.0.1-0.20221018141916-013ff4b65ecb
