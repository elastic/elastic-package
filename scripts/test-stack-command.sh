...
elastic-package stack status -v ${ARG_VERSION} 2> ${OUTPUT_PATH_STATUS}/initial.txt
...
elastic-package stack status -v ${ARG_VERSION} 2> ${OUTPUT_PATH_STATUS}/running.txt
